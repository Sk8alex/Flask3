...
from api.schemas.user import user_shema
...
def get_user_by_id(user_id: int):
    ...
    return jsonify(user_shema.dump(user)),200
...
def get_users(): #зефирка
    ...
    return jsonify(user_shema.dump(users, many=True)), 200
...
def create_user():
    ...
    return jsonify(user_shema.dump(user)), 201
